...
$baseSql = "SELECT id, sr_no, date, vehicle, bilty_no, party, feed_portion, location, bags, freight, commission, COALESCE(NULLIF(freight_payment_type, ''), 'to_pay') AS freight_payment_type, tender, profit FROM bilty";
if(count($ids) > 0){
