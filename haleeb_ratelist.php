          ...
          <tr class="edit-row">
            <form method="post">
              ...
              <td class="td-action">
                ...
                <a class="act-btn act-cancel" href="haleeb_ratelist.php">✕</a>
              </td>
            </form>
          </tr>
        <?php else: ?>
